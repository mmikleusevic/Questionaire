...
namespace QuestionaireApi.Migrations
{
    ...
    [Migration("20250313131959_AddedForeignKeyForAnswersAddedSoftDeleteToQuestionsAndQueryFilter")]
    partial class AddedForeignKeyForAnswersAddedSoftDeleteToQuestionsAndQueryFilter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0344c586-4932-4ee3-8854-65937effcbcf",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e8486713-5f7d-453b-96c3-b7c3d441afb4",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "ef202a8e-83b0-42fe-af2b-827a98535743",
                            Name = "SuperAdmin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "2db072f6-3706-4996-b222-343896c40606",
                            RoleId = "0344c586-4932-4ee3-8854-65937effcbcf"
                        },
                        new
                        {
                            UserId = "2db072f6-3706-4996-b222-343896c40606",
                            RoleId = "e8486713-5f7d-453b-96c3-b7c3d441afb4"
                        },
                        new
                        {
                            UserId = "2db072f6-3706-4996-b222-343896c40606",
                            RoleId = "ef202a8e-83b0-42fe-af2b-827a98535743"
                        });
                });
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.PendingQuestion", b =>
                {
                    ...
                    b.Property<string>("CreatedById")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("2db072f6-3706-4996-b222-343896c40606");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.QuestionCategory", b =>
                {
                    b.Property<int>("QuestionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.UserQuestionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bc88d4e2-8a6e-441b-9120-0cdd2a36ea55",
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Answer", b =>
                {
                    b.HasOne("QuestionaireApi.Models.Database.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Category", b =>
                {
                    b.HasOne("QuestionaireApi.Models.Database.Category", "ParentCategory")
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.PendingQuestion", b =>
                {
                    b.HasOne("QuestionaireApi.Models.Database.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("QuestionaireApi.Models.Database.User", "LastUpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.PendingQuestionCategory", b =>
                {
                    b.HasOne("QuestionaireApi.Models.Database.Category", "Category")
            ...
            modelBuilder.Entity("QuestionaireApi.Models.Database.Question", b =>
                {
                    b.HasOne("QuestionaireApi.Models.Database.User", "ApprovedBy")
                        .WithMany()
